...
if (!defined("From_Index")) { echo "<p style=\"text-align: center; color: red; font-weight: bold; font-size: 150%;\">".
                               "Помилка входу в модуль oil.php</p>"; return; }
...
if (!empty($_POST['sbtNext1'])) { ?>
	...
	if ($_POST['cbxIHaveSquare'] == "on") { // Не обчислюємо площу
		...
		?>
			<table style="margin: auto; width: 550px; font-size: 110%; border-collapse: collapse;">
				...
				<tr><td<?php echo $tdStyle; ?>>
							Площа нафтоносності, тис. м<span style="font-size: 75%; vertical-align: super;">2</span>
						</td>
				...
				<tr><td<?php echo $tdStyle; ?>>
							Початкові загальні <?php echo $Cat; ?> нафти, тис.&nbsp;т
						</td>
				...
				<tr><td<?php echo $tdStyle; ?>>
							Початкові добувні <?php echo $Cat; ?> нафти, тис.&nbsp;т
						</td>
		...
		<?php
			...
			Початкові добувні <?php echo $Cat; ?> нафти <?php echo $categoryWord; ?>&nbsp;<?php echo $CatSub." - ".$QExt; ?> тис. т<?php
		}
		return;
	}
